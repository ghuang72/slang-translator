...
const translateMessages = () => {
	var elements = document.querySelectorAll("span._3oh-._58nk");
	for (element of elements) {
		if (element.innerHTML) {
			...
			element.innerHTML = newTextArray.join(" ");
		}
	}
};

chrome.runtime.onMessage.addListener(() => {
	setInterval(translateMessages, 100);
});
